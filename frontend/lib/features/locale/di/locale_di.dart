...
import 'package:cookify/features/locale/data/data_sources/locale_stream_data_source_impl.dart';
...
abstract class LocaleDi {
  ...
  static final LocaleStreamDataSource _localeStreamDataSource =
      LocaleStreamDataSourceImpl();

  static LocaleRepository get _localeRepository => LocaleRepositoryImpl(
    localDataSource: _localeLocalDataSource,
    streamDataSource: _localeStreamDataSource,
  );
  ...
  static ListenLocaleUseCase get listenLocaleUseCase =>
      ListenLocaleUseCase(_localeRepository);
}
