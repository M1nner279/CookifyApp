  ...
  Future<Either<Failure, List<RecipePreview>>> getRecipeList() async {
    ...
    return Right([
      ...
      RecipePreview(
        ...
        servingCount:
            1, // В описании указана "небольшая сноровка", поэтому средний уровень
      ),

      RecipePreview(
        id: '2', // Оставил как есть
        photoUrls: [
          'https://www.russianfood.com/dycontent/images_upl/66/sm_65164.jpg',
        ], // Основное фото готовых лепешек
        ...
        difficulty: RecipeDifficulty.easy,
        servingCount: 1, // Рецепт позиционируется как "быстрое решение"
      ),
    ]);
  }
}
